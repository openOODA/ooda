...
**Status:** residual honesty (not enforced). PM **4.4**.  
**Marker:** `HOLOGRAPHIC_RESIDUAL_ALPHA`

## Named surface only (not product green)

- Named only: holographic persistence (DESIGN)
...
- No holographic persistence product path shipped

## Rails

- Doc marker: `HOLOGRAPHIC_RESIDUAL_ALPHA`
- Smoke: `scripts/holographic_residual_smoke.sh`
- Fixture: `fixtures/holographic_marker.oo` (marker comment only)
