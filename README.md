...
**openOODA Project** — `https://github.com/openOODA` — **Version `v0.104.0-alpha`**
...
## What's real in v0.104.0-alpha (CHS M0–M5)
...
| WASM strings + List[Int] | Real: `.len`/`.char_at`/`.contains`/`.str_slice`; List[Int] free+method + deep `==`. Lazy list RT; heap for slice. Refuse List[String]/caps. Dev wasmtime smoke |
