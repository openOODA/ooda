...
**openOODA Project** — `https://github.com/openOODA` — **Version `v0.102.0-alpha`**
...
## What's real in v0.102.0-alpha (CHS M0–M5)
...
| WASM strings + List[Int] | Real: strings + streq + `.len`/`.char_at`; List[Int] free+method; **list `==` deep content** (`$list_eq`, not streq). Refuse List[String]/caps. Fixture string_walk. Dev wasmtime smoke |
