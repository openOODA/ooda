...
**openOODA Project** — `https://github.com/openOODA` — **Version `v0.103.0-alpha`**
...
## What's real in v0.103.0-alpha (CHS M0–M5)
...
| WASM strings + List[Int] | Real: strings + streq + `.len`/`.char_at`/`.contains` (host); List[Int] free+method + deep `==`. Refuse List[String]/caps. Fixture string_walk. Dev wasmtime smoke |
