## v0.25.0-alpha — Honest net, fail-closed refinements, real AI diagnostic goldens
...
5. **Version pin alignment**  
   Canonical `v0.25.0-alpha` locked across Cargo, clap, README, `install/install.oo`,  
...
# or
tar xzf ooda-v0.25.0-alpha-linux-x86_64.tar.gz
export PATH="$PWD/ooda-v0.25.0-alpha-linux-x86_64/bin:$PATH"
